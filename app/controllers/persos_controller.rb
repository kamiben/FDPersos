class PersosController < ApplicationController
  ...
  def new
    @perso = Perso.new
    ['Profession','Age','Sexe','Nationalite','Residence','FOR','DEX','INT','Idee','CON','APP','POU','Chance','TAI','SAN','EDU','Connaissance','Ecoles','Diplomes','Bonus-Penalites',"Anthropologie","Esquiver","Piloter","Archeologie","Geologie",".",".","Arts","Grimper","..","...","Histoire","PremiersSoins","....","....","HistoireNaturelle","Psychanalyse","ArtsMartiaux","Lancer","Psychologie","Astronomie","LangueNatale","Sauter","Baratin",".....","Se Cacher"",Bibliotheque","Langues Etrangeres","Serrurerie","Biologie","......","Suivre une Piste","Bloquer (DEX X 2)",".......","Trouver Objet Cache (25)","Chimie (01)","Marchandage (05)","........","Comptabilite (10)","Mecanique (20)",".........","Conduire automobile (20)","Medecine (05)","..........","Conduire Engin lourd (01)","Monter a Cheval (05)","...........","Credit (15)","Mythe de Cthulhu","..","Criminalistique (01)","Nager (25)",".............","Deguisement (01)","Navigation (10)",".............","Discretion (15)","Occultisme (05)","...............","Dissimulation (15)","Persuasion (15)","................","Droit (05)","Pharmacologie (01)",".................","Ecouter (25)","Photographie (10)","..................","Electricite (10)","Physique (01)","...................","Arme1","ArmeDom1","ArmePor1","ArmePan1","ArmeEmpal1","ArmeTirs1","ArmePdv1","ArmeMun1","Arme2","ArmeDom2","ArmePor2","ArmePan2","ArmeEmpal2","ArmeTirs2","ArmePdv2","ArmeMun2","Arme3","ArmeDom3","ArmePor3","ArmePan3","ArmeEmpal3","ArmeTirs3","ArmePdv3","ArmeMun3","Coupdepiedpct","Coupdepieddom","Coupdepiedatt","Coupdepiedpdv","Coupdepoingpct","Coupdepoinfdom","Coupdepoingatt","Coupdepoingpdv","Coupdetetepct","Coupdetetedom","Coupdeteteatt","Coupdetetepdv","Luttepct","Luttedom","Lutteatt","Luttepdv","NomArmeCac","Armecacpct","Armecacdom","Armecacatt","Armecacpdv","NomArmeCac2","Armecacpct2","Armecacdom2","Armecacatt2","Armecacpdv2","Revenus","Economies","Argent de poche","Biens personnels","Richesse Reelle","Informations Personnelles","Description","Famille / Amis","Crises de Folie","Blessures","Cicatrices / Balafres","Materiel et Possessions","Vehicules","Entitees recontrees","Ouvrages / Grimoires lus","Objets Magiques / Sortileges Connus"].each do |nom|
